...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/format-outdent-rtl.js");
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/format-outdent.js");
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/format-list-bullets-rtl.js");
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/format-list-bullets.js");
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/format-list-numbered-rtl.js");
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/format-list-numbered.js");
...
/* harmony import */ var _ordered_list_settings__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ordered-list-settings */ "./src/icon-list/ordered-list-settings.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./utils */ "./src/icon-list/utils.js");
/* harmony import */ var _tag_name__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./tag-name */ "./src/icon-list/tag-name.js");
...
function useMigrateOnLoad(attributes, clientId) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    ...
    _wordpress_deprecated__WEBPACK_IMPORTED_MODULE_7___default()('Value attribute on the list block', {
      since: '6.0',
      version: '6.5',
...
function useOutdentList(clientId) {
  const {
    canOutdent
  } = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(innerSelect => {
    const {
  ...
  return [canOutdent, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useCallback)(() => {
...
function IndentUI(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarButton, {
    icon: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.isRTL)() ? _wordpress_icons__WEBPACK_IMPORTED_MODULE_11__["default"] : _wordpress_icons__WEBPACK_IMPORTED_MODULE_12__["default"],
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Outdent'),
    describedBy: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Outdent list item'),
    disabled: !canOutdent,
    onClick: outdentList
  }));
}
...
function Edit(_ref2) {
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({ ...(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Platform.isNative && {
      style
    })
  });
  ...
  const controls = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, {
    group: "block"
    ...
    icon: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.isRTL)() ? _wordpress_icons__WEBPACK_IMPORTED_MODULE_13__["default"] : _wordpress_icons__WEBPACK_IMPORTED_MODULE_14__["default"],
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Unordered'),
    describedBy: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Convert to unordered list'),
    ...
    icon: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.isRTL)() ? _wordpress_icons__WEBPACK_IMPORTED_MODULE_15__["default"] : _wordpress_icons__WEBPACK_IMPORTED_MODULE_16__["default"],
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Ordered'),
    describedBy: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Convert to ordered list'),
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(IndentUI, {
    clientId: clientId
  }));
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_tag_name__WEBPACK_IMPORTED_MODULE_10__["default"], (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
    ordered: ordered,
    reversed: reversed,
    start: start,
    type: type
  }, innerBlocksProps)), controls, ordered && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_ordered_list_settings__WEBPACK_IMPORTED_MODULE_8__["default"], {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/icon-list/style.scss");
/**
 * WordPress dependencies
 */
...
/***/ "./src/icon-list/ordered-list-settings.js":
/*!************************************************!*\
  !*** ./src/icon-list/ordered-list-settings.js ***!
  \************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const OrderedListSettings = _ref => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Ordered list settings')
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Start value'),
    type: "number",
    onChange: value => {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Reverse list numbering'),
...
/* harmony default export */ __webpack_exports__["default"] = (OrderedListSettings);
...
/* harmony default export */ __webpack_exports__["default"] = ((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.forwardRef)(TagName));

/***/ }),

/***/ "./src/icon-list/utils.js":
/*!********************************!*\
  !*** ./src/icon-list/utils.js ***!
  \********************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createListBlockFromDOMElement": function() { return /* binding */ createListBlockFromDOMElement; },
/* harmony export */   "migrateToListV2": function() { return /* binding */ migrateToListV2; }
/* harmony export */ });
...
function createListBlockFromDOMElement(listElement) {
  ...
  const innerBlocks = Array.from(listElement.children).map(listItem => {
    ...
    return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('core/list-item', childAttributes, childInnerBlocks);
  });
  return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('core/list', listAttributes, innerBlocks);
}
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"themezee/icon-list","version":"0.1.0","title":"Icon List","category":"text","description":"Create an icon list.","attributes":{"ordered":{"type":"boolean","default":false,"__experimentalRole":"content"},"values":{"type":"string","source":"html","selector":"ol,ul","multiline":"li","__unstableMultilineWrapperTags":["ol","ul"],"default":"","__experimentalRole":"content"},"type":{"type":"string"},"start":{"type":"number"},"reversed":{"type":"boolean"},"placeholder":{"type":"string"}},"supports":{"anchor":true,"className":false,"typography":{"fontSize":true,"lineHeight":true,"__experimentalFontFamily":true,"__experimentalFontWeight":true,"__experimentalFontStyle":true,"__experimentalTextTransform":true,"__experimentalTextDecoration":true,"__experimentalLetterSpacing":true,"__experimentalDefaultControls":{"fontSize":true}},"color":{"gradients":true,"link":true,"__experimentalDefaultControls":{"background":true,"text":true}},"spacing":{"margin":true,"padding":true},"__unstablePasteTextInline":true,"__experimentalSelector":"ol,ul","__experimentalSlashInserter":true},"textdomain":"advanced-icon-block","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
